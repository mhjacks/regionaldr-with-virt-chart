...
| drpc.kubeObjectProtection.kubeObjectSelector.matchExpressions[0].key | string | `"drprotection"` |  |
| drpc.kubeObjectProtection.kubeObjectSelector.matchExpressions[0].operator | string | `"In"` |  |
| drpc.kubeObjectProtection.kubeObjectSelector.matchExpressions[0].values[0] | string | `"true"` |  |
...
| drpc.pvcSelector.matchExpressions[0].key | string | `"app.kubernetes.io/component"` |  |
| drpc.pvcSelector.matchExpressions[0].operator | string | `"In"` |  |
